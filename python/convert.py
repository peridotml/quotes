...
def convert_file(
    ...
    to_removes = _remove_duplicate_names(loaded, discard_names=discard_names, preferred_names=["cls.predictions.decoder.bias"])
    print(to_removes)
    metadata = {"format": "pt"}
...
def convert(
    ...
    folder = os.path.join(current_dir, repo_folder_name(repo_id=model_id, repo_type="models"))
